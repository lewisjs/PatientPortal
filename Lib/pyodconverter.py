# make sure this is started first as www-data or root: libreoffice --nologo --nofirststartwizard --headless --norestore --invisible "--accept=socket,host=localhost,port=2002,tcpNoDelay=1;urp;"
#
#

...
<?php echo $this->Form->create('PatientRelationship'); ?>
	<fieldset>
		<legend><?php echo __('Edit Patient Relationship'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PatientRelationship.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PatientRelationship.id'))); ?></li>

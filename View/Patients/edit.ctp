...
<?php echo $this->Form->create('Patient'); ?>
	...
	<?php
		...
		echo $this->Form->input('patient_gender_id', array('label' => 'Gender', 'empty' => 'Choose One', ));
		...
		echo '</div>';
		echo $this->Form->input('patient_marital_status_id', array('label' => 'Marital Status', 'empty' => 'Choose One'));
		echo $this->Form->input('location_id', array('label' => 'Preferred Location', 'empty' => 'Choose One'));
	?>
	</fieldset>

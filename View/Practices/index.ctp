<div class="practices index">
	...
	<tr>
		...
		<td><?php echo h($practice['Practice']['description']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $practice['Practice']['id']), null, __('Are you sure you want to delete # %s?', $practice['Practice']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>

<div class="users index">
	...
	<tr>
		...
		<td><?php echo $user['User']['validated'] ? "true" : "false"; ?>&nbsp;</td>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('List User Tickets'), array('controller' => 'user_tickets', 'action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New User Ticket'), array('controller' => 'user_tickets', 'action' => 'add')); ?> </li>

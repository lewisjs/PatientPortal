...
<div class="related">
	...
	<?php if (!empty($group['UserHistory'])): ?>
	...
	<?php
		$i = 0;
		foreach ($group['UserHistory'] as $userHistory): ?>
		<tr>
			<td><?php echo $userHistory['id']; ?></td>
			<td><?php echo $userHistory['user_id']; ?></td>
			<td><?php echo $userHistory['modified_by']; ?></td>
			<td><?php echo $userHistory['username']; ?></td>
			<td><?php echo $userHistory['email']; ?></td>
			<td><?php echo $userHistory['password']; ?></td>
			<td><?php echo $userHistory['group_id']; ?></td>
			<td><?php echo $userHistory['modified']; ?></td>
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'user_histories', 'action' => 'delete', $userHistory['id']), null, __('Are you sure you want to delete # %s?', $userHistory['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>

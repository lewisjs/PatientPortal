...
<?php echo $this->Form->create('QuestionnairePage'); ?>
	<fieldset>
		<legend><?php echo __('Edit Questionnaire Page'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('QuestionnairePage.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('QuestionnairePage.id'))); ?></li>
